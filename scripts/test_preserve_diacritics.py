...
def test_case_4_diacritic_strip_flagged() -> None:
    ...
    v = check_pair(old, new)
    _assert(any("vietnamese-diacritic-strip" in r for r, _, _ in v), "detects diacritic strip")
...
def test_case_10_similar_helper() -> None:
    ...
    _assert(not similar("hello world", "completely different text here"), "different strings not similar")
