...
### Pre-commit lint (script `scripts/repo-bootstrap/verify-readme-sync.sh` invoked from profile repo)
...
Location: `n24q02m/n24q02m/scripts/repo-bootstrap/*.sh` (after Pattern A reorg of profile repo).
...
- [ ] GitHub-detail audit (6-medium scope) passes via `scripts/repo-bootstrap/audit.sh`?
